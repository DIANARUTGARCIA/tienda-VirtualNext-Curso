...
const ProductAdminPage: FC<Props> = ({ product }) => {
  ...
  //Función para el cambio de los check de la tallas
  ...
  const onSubmit = async (form: FormData) => {
    if (form.images.length < 2) return alert('Minimo de 2 imagenes')
    setIsSaving(true)
    try {
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <TextField
              ...
              {...register('inStock', {
                required: 'Este campo es requerido',
                min: { value: 0, message: 'Minimo del valor cero' },
              })}
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              {...register('slug', {
                ...
                validate: (val) =>
                  val.trim().includes(' ')
                    ? 'No puede tener espacios en blancio'
                    : undefined,
              })}
              error={!!errors.slug}
